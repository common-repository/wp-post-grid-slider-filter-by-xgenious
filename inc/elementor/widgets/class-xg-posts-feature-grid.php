 ...
 */
class Xg_Post_Featured_Grid_elementor_addon extends Widget_Base
{
    /**
     * Define our get_name settings.
     */
    public function get_name(){
        return 'xg-posts-featured-grid';
    }
    /**
     * Define our get_title settings
     */
    public function get_title(){
        return esc_html__('Xg Featured Grid', 'wp-post-layout');
    }
    /**
    ...
    protected function _register_controls(){
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'options' => \Xg_Post_Helpers::post_query('xgp-featured'),
    ...
    protected function render(){
        ...
        $shortcode = '[xg_featured_grid  id="'.$id.'"]';
...
Plugin::instance()->widgets_manager->register_widget_type( new Xg_Post_Featured_Grid_elementor_addon() );
