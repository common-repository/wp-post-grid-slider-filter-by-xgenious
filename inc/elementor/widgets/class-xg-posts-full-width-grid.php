 ...
 */
class Xg_Post_Full_Width_Grid_elementor_addon extends Widget_Base
{
    /**
     * Define our get_name settings.
     */
    public function get_name(){
        return 'xg-posts-full-width-grid';
    }
    /**
     * Define our get_title settings
     */
    public function get_title(){
        return esc_html__('Xg Full Width Grid', 'wp-post-layout');
    }
    /**
    ...
    protected function _register_controls(){
        ...
        $this->start_controls_section(
            'section_my_custom',
            [
                'label' => esc_html__( 'XG Featured Grid', 'wp-post-layout' ),
            ]
        );
        $this->add_control(
            'select_shotcode',
            [
                ...
                'default' => '',
                'options' => \Xg_Post_Helpers::post_query('xgp-full-width'),
    ...
    protected function render(){
        ...
        $shortcode = '[xg_post_full_width_grid  id="'.$id.'"]';
...
Plugin::instance()->widgets_manager->register_widget_type( new Xg_Post_Full_Width_Grid_elementor_addon() );
