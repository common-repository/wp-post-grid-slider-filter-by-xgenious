 ...
 */
class Xg_Post_Layout_grid_elementor_addon extends Widget_Base
{
    /**
     * Define our get_name settings.
     */
    public function get_name(){
        return 'xg-posts-layout-grid';
    }
    /**
     * Define our get_title settings
     */
    public function get_title(){
        return esc_html__('Xg Layouts', 'wp-post-layout');
    }
    /**
    ...
    protected function _register_controls(){
        ...
        $this->start_controls_section(
            'section_my_custom',
            [
                'label' => esc_html__( 'XG Post Layouts', 'wp-post-layout' ),
            ]
        );
        $this->add_control(
            'select_shotcode',
            [
                ...
                'default' => '',
                'options' => \Xg_Post_Helpers::post_query('xgp-post-layout'),
    ...
    protected function render(){
        ...
        $shortcode = '[xg_post__layouts  id="'.$id.'"]';
...
Plugin::instance()->widgets_manager->register_widget_type( new Xg_Post_Layout_grid_elementor_addon() );
